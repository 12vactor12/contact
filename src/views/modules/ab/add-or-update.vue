    ...
    >
      <el-row>
        ...
        <el-form-item class="input" label="姓名" prop="name">
		  ...
		  <el-form-item class="input" label="电子邮件地址" prop="email">
		      <el-input v-model="ruleForm.email" 
		        placeholder="电子邮件地址"></el-input>
		  </el-form-item>
		  <el-form-item class="input" label="社交媒体账号" prop="smaccounts">
		      <el-input v-model="ruleForm.smaccounts" 
		        placeholder="社交媒体账号"></el-input>
		  </el-form-item>
		  <el-form-item class="input" label="居住地址" prop="address">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ab/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.contactCrossAddOrUpdateFlag = false;
                  this.parent.search();
