			...
			label="电子邮件地址">
			 <template slot-scope="scope">
              ...
              <el-table-column width="300" :align="contents.tableAlign"
                ...
                label="操作">
                <template slot-scope="scope">    
				<el-button  type="success" v-if="scope.row.coltype=='未关联'" size="mini" @click="addOrUpdateHandler(scope.row.id)">关联</el-button>
                </template>
            </el-table-column>
        </el-table>
                                                                                                                                                                                                <el-pagination
...
export default {
  ...
  methods: {
    ...
    getDataList() {
	  ...
	  if(this.fromId=='' || this.fromId==undefined){
		  return;
	  }
      let params = {
        page: this.pageIndex,
    ...
    addOrUpdateHandler(id) {
      ...
      this.$confirm(`确定进行[${id ? "关联" : "批量关联"}]操作?`, "提示", {
